...
<style type="text/css">
  ...
  <body>
    ...
    <form action="<c:url value='/background/BgCategoryServlet'/>" method="post" onsubmit="return checkForm()">
    	...
    	一级分类：<select name="pid" id="pid">
    		...
    		<c:forEach items="${parents }" var="parent">
    			<option value="${parent.cid }" <c:if test="${child.parent.cid eq parent.cid }">selected="selected"</c:if> >
    				${parent.cname }
    			</option>
    		</c:forEach>
